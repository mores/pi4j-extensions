...
public class LedColor {
     ...
     *
     * @param wheelPos
     *            Position on the Color wheel (range 0..255).
     *
    ...
    public static int createColorRGB(float red, float green, float blue) {
        return createColorRGB(Math.round(Color_COMPONENT_MAX * red), Math.round(Color_COMPONENT_MAX * green),
     ...
     *
     * @param red
     *            Red component {@code 0 to 255}
     * @param green
     *            Green component {@code 0 to 255}
     * @param blue
     *            Blue component {@code 0 to 255}
     *
     * @return RGB Color integer value
     */
     ...
     *
     * @param hue
     *            The hue, in degrees, {@code 0.0 to 360.0}
     * @param saturation
     *            The saturation %, {@code 0.0 to 1.0}
     * @param luminance
     *            The luminance %, {@code 0.0 to 1.0}
     *
     * @return RGB Color integer value
     *
     * @throws IllegalArgumentException
     *             if {@code hue}, {@code saturation}, {@code brightness} are out of range
     */
